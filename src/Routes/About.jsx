...
function About(){
    return (
        ...
        <div className="periodic-table">
            ...
            <div className="periodic-element social-media" data-description="I'm only on here to reject invitations 😂">
                <div className="periodic-element-inner">
                    <div className="title">Li</div>
                    <div className="description">LinkedIn</div>
                </div>
            </div>
            <div className="periodic-element social-media" data-description="Only so I don't miss out on my friends' milestones 🤷">
                <div className="periodic-element-inner">
            ...
            </div><a className="periodic-element social-media" data-description="If you say something witty, it's going on my Twitter 🐦" href="https://twitter.com/meowlivia_" target="_blank">
                <div className="periodic-element-inner">
            ...
            <div className="periodic-element just-trying" data-description="I just need to stop adding items and actually start doing things. Am I the only one who is still using Wunderlist? 😂">
                <div className="periodic-element-inner">
            ...
            </div><a className="periodic-element fun-stuff" data-description="Getting distracted by Toggl comics 🙃" href="https://blog.toggl.com" target="_blank">
                <div className="periodic-element-inner">
            ...
            <div className="periodic-element just-trying" data-description="I spend so much time on Codepen, I decided to go Pro because I felt bad 💸">
                <div className="periodic-element-inner">
            ...
            </div><a className="periodic-element social-media" data-description="Fuck this app. It's a terrible love-hate relationship." href="https://www.instagram.com/meowliviaaa/" target="_blank">
                <div className="periodic-element-inner">
                    <div className="title">In</div>
                    <div className="description">Instagram</div>
                </div>
            </a><a className="periodic-element fun-stuff" data-description="Obsessing over musicals and stalking broadway stars is 👏🏻 not 👏🏻 a 👏🏻 crime!" href="https://codepen.io/collection/XPWkdW/" target="_blank">
                <div className="periodic-element-inner">
            ...
            <div className="periodic-element social-media" data-description="Oh my god. Someone please save me from this Reddit hell hole 😭">
                <div className="periodic-element-inner">
        ...
        <div className="legend-table">
            <div className="legend-table__wrapper"><span className="legend-table__marker social-media"></span><span className="legend-table__text">Front-End Skill</span><span className="legend-table__marker intense-work"></span><span className="legend-table__text">Back-End Skill</span><span className="legend-table__marker just-trying"></span><span className="legend-table__text">Design Tool</span><span className="legend-table__marker fun-stuff"></span><span className="legend-table__text">ETC</span><br />    
            </div>
        </div>
